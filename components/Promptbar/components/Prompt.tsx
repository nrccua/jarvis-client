...
export const PromptComponent = ({ prompt }: Props) => {
  ...
  return (
    <div className="relative flex items-center">
      <button
        className="prose flex w-full cursor-pointer items-center gap-3 rounded-lg p-3 text-sm transition-colors duration-200 hover:bg-gray-200/90"
        draggable="true"
        onClick={(e) => {
          e.stopPropagation();
          setShowModal(true);
      ...
      {(isDeleting || isRenaming) && (
        <div className="absolute right-1 z-10 flex text-gray-700">
