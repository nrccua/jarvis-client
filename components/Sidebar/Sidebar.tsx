...
const Sidebar = <T,>({
  ...
  const highlightDrop = (e: any) => {
    e.target.style.background = '#d2d2d2';
  };
  ...
  return isOpen ? (
    <div>
      <div
        className={`fixed top-0 ${side}-0 z-40 flex h-full w-[260px] flex-none flex-col space-y-2 bg-gray-50 p-2 text-[14px] transition-all sm:relative sm:top-0`}
        style={{
